...
/* ------------------------------------------------------------------
   ✅ API Base URLs
   These are loaded from your .env file. If not found, fallback to localhost.
------------------------------------------------------------------- */

const USER_API_URL =
  import.meta.env.VITE_USER_API_URL || "http://localhost:8080/api/users";

const QUIZ_API_URL =
  import.meta.env.VITE_QUIZ_API_URL || "http://localhost:8080/api/quizzes";
